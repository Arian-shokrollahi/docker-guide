...
ا-Hypervisor یک نرم‌افزار یا لایه مدیریتی است که روی سخت‌افزار قرار می‌گیرد و منابع سرور (CPU، RAM، Storage) را بین چند **Virtual Machine** تقسیم می‌کند.
...
ا-Virtual Machine یک کامپیوتر مجازی است که روی Hypervisor ساخته می‌شود و مثل یک کامپیوتر واقعی سیستم‌عامل و برنامه اجرا می‌کند.
